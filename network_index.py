...
class NetWork():
    def __init__(self,n_inpt,n_single,n_hidden,embedding_file,n_embedding):
        ## input = 1738 for cn 1374 for en
        ## embedding for each mention = 855 for cn, 673 for en
        ## pair_feature = 28

        ## 714 for candidates, 343 for self
        ...
        self.predict = theano.function(
            inputs=[self.x_inpt_single_embedding,self.x_inpt_single_index,self.x_inpt_embedding,self.x_inpt_index],
            outputs=[self.policy],
        ...
        self.train_step = theano.function(
            inputs=[self.x_inpt_single_embedding,self.x_inpt_single_index,self.x_inpt_embedding,self.x_inpt_index,y,Reward,lr],
            outputs=[cost],
            on_unused_input='warn',
            updates=updates)
        ...
        self.pre_train_step = theano.function(
            inputs=[self.x_inpt_single_embedding,self.x_inpt_single_index,self.x_inpt_embedding,self.x_inpt_index,lable,pre_lr],
            outputs=[pre_cost],
            on_unused_input='warn',
            updates=pre_updates)
